...
def count(y_true, type="tx", cards=None):
  if type == "tx":
    ...
    if cards is not None:
      ...
      raise ValueError("cards values are None while trying to calculate the count for cards")
  else:
...
def count_fraud(y_true, type="tx", cards=None):
  if type == "tx":
    ...
    if cards is not None:
      ...
      raise ValueError("cards values are None while trying to calculate the count-fraud for cards")
  else:
...
def true_positive(y_true, y_pred, type="tx", cards=None):
  if type == "tx":
    ...
    if cards is not None:
      ...
      raise ValueError("cards values are None while trying to calculate the true_positive for cards")
  else:
...
def true_negative(y_true, y_pred, type="tx", cards=None):
  if type == "tx":
    ...
    if cards is not None:
      ...
      raise ValueError("cards values are None while trying to calculate the true_negative for cards")
  else:
    raise ValueError("true_negative for " + str(type) + " is not implemented")
...
def false_positive(y_true, y_pred, type="tx", cards=None):
  if type == "tx":
    ...
    if cards is not None:
      ...
      raise ValueError("cards values are None while trying to calculate the false_positive for cards")
  else:
...
def false_negative(y_true, y_pred, type="tx", cards=None):
  if type == "tx":
    ...
    if cards is not None:
      ...
      raise ValueError("cards values are None while trying to calculate the false_negative for cards")
  else:
    raise ValueError("false_negative for " + str(type) + " is not implemented")
...
def amount_saved(y_true, y_pred, amounts, cards=None):
  if cards is not None:
    raise ValueError("The metric 'amount_saved' has not been implemented for cards. It only looks at transactions.")
...
def precision(y_true, y_pred, type="tx", cards=None, reference_ratio=None):
  if type == "tx":
    ...
    if cards is not None:
      ...
      raise ValueError("cards values are None while trying to calculate the precision for cards")
  else:
  ...
  if (tp + fp) == 0:
    ...
    calibration_factor = pi_current * (1 - reference_ratio) / (reference_ratio * (1 - pi_current))
...
def recall(y_true, y_pred, type="tx", cards=None):
  if type == "tx":
    ...
    if cards is not None:
      ...
      raise ValueError("cards values are None while trying to calculate the recall for cards")
  else:
    raise ValueError("recall for " + str(type) + " is not implemented")


def f_score(y_true, y_pred, type="tx", cards=None, reference_ratio=None):
  p = precision(y_true, y_pred, type=type, cards=cards, reference_ratio=reference_ratio)
  ...
  if type == "tx":
    ...
    if cards is not None:
      if sorted:
        ...
        y_true_sorted, _, cards_sorted = sort_in_unison(y_true, y_score, cards=cards)
      ...
      raise ValueError("cards values are None while trying to calculate the pk {} for a card".format(rank))
  else:
...
def plot_precision_recall_curve(y_true, y_score, type="tx", cards=None, title=None, plot_save_path=None,
  ...
  precisions, recalls, thresholds = precision_recall_curve(y_true, y_score, type=type, cards=cards)
  ...
  pr_auc_score = pr_auc(y_true, y_score, recall_value=1.0, type=type, cards=cards, sorted=False)
...
def pr_auc(y_true, y_score, recall_value=1.0, type="tx", cards=None, sorted=False, reference_ratio=None):
  if type == "tx":
    ...
    if cards is not None:
      ...
      raise ValueError("cards values are None while trying to calculate the PR-AUC {} for a card".format(recall_value))
  else:
